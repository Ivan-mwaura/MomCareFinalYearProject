...
const Patients = () => {
  ...
  const handleRegisterChange = (e) => {
    ...
    if (name === "weeksPregnant") {
      ...
      if (!isNaN(weeks)) {
        ...
        dueDate.setDate(today.getDate() + ((40 - weeks) * 7)); // Assuming 40 weeks pregnancy
  ...
  const handleRegisterMother = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        ...
        // Handle field-specific errors (400, 409)
  ...
  // Update the ErrorModal component
  ...
  // Add PropTypes validation for ErrorModal
              ...
              <div className="modal-content register-form">
                ...
                <form onSubmit={handleRegisterMother}>
                      ...
                      <div className="form-group">
                        ...
                        <label>
                          ...
                          >
                            ...
                            {newMother.county &&
                              Object.keys(locationData[newMother.county]).map((constituency) => (
                        ...
                        <label>
                          ...
                          >
                            ...
                            {newMother.constituency &&
                              locationData[newMother.county][newMother.constituency].map((ward) => (
                    ...
                    <div className="form-section">
                      ...
                      <div className="form-group">
                        <label>
                          ...
                          {formErrors.pregnancyStage && <span className="error-message">{formErrors.pregnancyStage}</span>}
                        </label>
                        <label>
                          Weeks Pregnant:
                          <input
                          ...
                          />
                          {formErrors.weeksPregnant && <span className="error-message">{formErrors.weeksPregnant}</span>}
                        </label>
                      </div>
                      <div className="form-group">
                        <label>
                  ...
                  <div className="form-actions">
                    ...
                    <button type="button" className="cancel-btn" onClick={() => setShowRegisterForm(false)}>
                      Cancel
                    </button>
                  </div>
                </form>
